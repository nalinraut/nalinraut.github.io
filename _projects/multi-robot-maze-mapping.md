...
description: Swarm robotics maze exploration using multiple robots with optimized Recursive Backtracking algorithm and A* path planning.
img: assets/img/AI_project.gif
importance: 1
category: work
---
